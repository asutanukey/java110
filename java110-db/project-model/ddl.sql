...
CREATE TABLE `p1_board` (
    `bno`  INTEGER      NOT NULL COMMENT '게시물 번호', -- 게시물 번호
...
ALTER TABLE `p1_board`
    MODIFY COLUMN `bno` INTEGER NOT NULL AUTO_INCREMENT COMMENT '게시물 번호';
...
CREATE TABLE `p1_tchr` (
    ...
    `subj`  VARCHAR(255) NULL     COMMENT '강의 과목' -- 강의 과목
)
COMMENT '강사';
...
CREATE TABLE `p1_lect` (
    ...
    `tot_hr` INTEGER      NOT NULL COMMENT '총 강의시간', -- 총 강의시간
    `day_hr` INTEGER      NOT NULL COMMENT '일 강의시간', -- 일 강의시간
...
ALTER TABLE `p1_lect_tchr`
    ADD CONSTRAINT `PK_p1_lect_tchr` -- 강사 강의 배정 기본키
        PRIMARY KEY (
            `tno`, -- 강사번호
            `lno`  -- 강의번호
        );
...
ALTER TABLE `p1_lect_stud`
    ADD CONSTRAINT `PK_p1_lect_stud` -- 학생 강의 배정 기본키
        PRIMARY KEY (
            `sno`, -- 학생번호
            `lno`  -- 강의번호
        );
...
-- 강사 강의 배정
ALTER TABLE `p1_lect_tchr`
    ADD CONSTRAINT `FK_p1_tchr_TO_p1_lect_tchr` -- 강사 -> 강사 강의 배정
        FOREIGN KEY (
            `tno` -- 강사번호
        )
...
-- 강사 강의 배정
ALTER TABLE `p1_lect_tchr`
    ADD CONSTRAINT `FK_p1_lect_TO_p1_lect_tchr` -- 강의 -> 강사 강의 배정
        FOREIGN KEY (
            `lno` -- 강의번호
        )
...
-- 학생 강의 배정
ALTER TABLE `p1_lect_stud`
    ADD CONSTRAINT `FK_p1_stud_TO_p1_lect_stud` -- 학생 -> 학생 강의 배정
        FOREIGN KEY (
            `sno` -- 학생번호
        )
...
-- 학생 강의 배정
ALTER TABLE `p1_lect_stud`
    ADD CONSTRAINT `FK_p1_lect_TO_p1_lect_stud` -- 강의 -> 학생 강의 배정
        FOREIGN KEY (
            `lno` -- 강의번호
        )
        REFERENCES `p1_lect` ( -- 강의
